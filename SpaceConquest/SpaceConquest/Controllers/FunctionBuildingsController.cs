...
using SpaceConquest.Data;
using SpaceConquest.DataContract.Models;

namespace SpaceConquest.Controllers
{
    public class FunctionBuildingsController : Controller
    {
        private SpaceConquestContext db = new SpaceConquestContext();
